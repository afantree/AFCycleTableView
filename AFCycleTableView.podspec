#
#  Be sure to run `pod spec lint AFCommon.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "阿凡树" => "729397005@qq.com" }
  # Or just: s.author    = "阿凡树"
  # s.authors            = { "阿凡树" => "729397005@qq.com" }
  # s.social_media_url   = "http://twitter.com/阿凡树"
